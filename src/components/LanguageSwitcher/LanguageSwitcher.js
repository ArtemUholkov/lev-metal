  ...
  return (
    <div className="lang_container">
      <div
        ...
        <img
          src={`./img/languageSwitcher/${changeFlag ? 'UA-flag-icon' : 'RU-flag-icon'}.png`}
          alt="UA Flag"
          className="flag_icon"
        />
        <img
          src="./img/languageSwitcher/Vector.png"
          alt="Arrow switcher"
          className={`arrow_icon ${open ? 'rotate' : 'norotate'}`}
        />
      </div>
